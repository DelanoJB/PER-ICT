...
@section('page_heading','Protocollen')
...
<br>
    ...
    <a href="{{ url ('/bradycardiekind') }}" class="btn btn-info">6.5 Bradycardie Kind</a> <br><br>
...
<br>
    ...
    <a href="{{ url ('/hypohyperthermie') }}" class="btn btn-info">7.6 Hypo / Hyperthermie</a> <br><br>
    ...
    <a href="{{ url ('/neusbloeding') }}" class="btn btn-info">7.11 Neusbloeding</a><br><br>
